...
{$A-}
  ...
  TDirectories = record
    ...
    Name: array[0..31] of Char; // Name del Directory
...
begin
  ...
  begin
    repeat
      ...
      Entry.Directory := (SR.Attr and faDirectory) = faDirectory;
      Entry.Attributes := SR.Attr;

      if not Entry^.Directory then //((SR.Attr and faArchive) = faArchive) or (SR.Attr = 0) then
      begin
