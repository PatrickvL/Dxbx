...
//    {00000294}NV2A_LIGHT_MODEL: Result := X_D3DRS_LIGHTING; ??
...
//    {00000314}NV2A_LIGHTING_ENABLE: Result := X_D3DRS_LIGHTING; ??
    ...
    {00001d7c}NV2A_MULTISAMPLE_CONTROL: Result := X_D3DRS_MULTISAMPLEANTIALIAS; // Also send by D3DRS_MULTISAMPLEMASK (both values in 1 command)
    {00001d84}NV2A_OCCLUDE_ZSTENCIL_EN: Result := X_D3DRS_OCCLUSIONCULLENABLE;
...
//    $00001d90: Result := X_D3DRS_SIMPLE_UNUSED8;
    ...
    {00001e6c}NV2A_TX_RCOMP: Result := X_D3DRS_SHADOWFUNC;
