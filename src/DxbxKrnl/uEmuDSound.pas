...
//  XTL_EmuCDirectSoundStream_GetStatus name PatchPrefix + 'DirectSound.CDirectSoundStream.GetStatus',
  XTL_EmuCDirectSoundStream_Pause name PatchPrefix + '?Pause@CDirectSoundStream@DirectSound@@QAGJK@Z',
...
//  XTL_EmuCDirectSoundStream_Release name PatchPrefix + 'DirectSound.CDirectSoundStream.Release',
  XTL_EmuCDirectSoundStream_SetAllParameters name PatchPrefix + '?SetAllParameters@CDirectSoundBuffer@DirectSound@@QAGJPBU_DS3DBUFFER@@K@Z',
  XTL_EmuCDirectSoundStream_SetConeAngles name PatchPrefix + '?SetConeAngles@CDirectSoundBuffer@DirectSound@@QAGJKKK@Z',
  XTL_EmuCDirectSoundStream_SetConeOrientation name PatchPrefix + '?SetConeOrientation@CDirectSoundBuffer@DirectSound@@QAGJMMMK@Z',
  XTL_EmuCDirectSoundStream_SetConeOutsideVolume name PatchPrefix + '?SetConeOutsideVolume@CDirectSoundBuffer@DirectSound@@QAGJJK@Z',
  XTL_EmuCDirectSoundStream_SetEG name PatchPrefix + '?SetEG@CDirectSoundBuffer@DirectSound@@QAGJPBU_DSENVELOPEDESC@@@Z',
  XTL_EmuCDirectSoundStream_SetFilter name PatchPrefix + '?SetFilter@CDirectSoundBuffer@DirectSound@@QAGJPBU_DSFILTERDESC@@@Z',
  XTL_EmuCDirectSoundStream_SetFrequency name PatchPrefix + '?SetFrequency@CDirectSoundBuffer@DirectSound@@QAGJK@Z',
  XTL_EmuCDirectSoundStream_SetMaxDistance name PatchPrefix + '?SetMaxDistance@CDirectSoundBuffer@DirectSound@@QAGJMK@Z',
  XTL_EmuCDirectSoundStream_SetMinDistance name PatchPrefix + '?SetMinDistance@CDirectSoundBuffer@DirectSound@@QAGJMK@Z',
  XTL_EmuCDirectSoundStream_SetMixBins name PatchPrefix + '?SetMixBins@CDirectSoundBuffer@DirectSound@@QAGJPBU_DSMIXBINS@@@Z',
  XTL_EmuCDirectSoundStream_SetMode name PatchPrefix + '?SetMode@CDirectSoundBuffer@DirectSound@@QAGJKK@Z',
  XTL_EmuCDirectSoundStream_SetPosition name PatchPrefix + '?SetPosition@CDirectSoundBuffer@DirectSound@@QAGJMMMK@Z',
  XTL_EmuCDirectSoundStream_SetRolloffFactor name PatchPrefix + '?SetRolloffFactor@CDirectSoundBuffer@DirectSound@@QAGJMK@Z',
  XTL_EmuCDirectSoundStream_SetVelocity name PatchPrefix + '?SetVelocity@CDirectSoundBuffer@DirectSound@@QAGJMMMK@Z',
  XTL_EmuCDirectSoundStream_SetVolume name PatchPrefix + '?SetVolume@CDirectSoundBuffer@DirectSound@@QAGJJ@Z',
