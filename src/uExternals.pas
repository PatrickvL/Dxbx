...
procedure CxbxKrnl_Init(hwndParent: THandle;
                       ...
                       Entry: PEntryProc); cdecl; external CCXBXKRNLDLLNAME name CCXBXKRNLINIT;
procedure Cxbx_Init(hwndParent: THandle;
                       ...
                       pXbeHeader: P_XBE_HEADER;
                       dwXbeHeaderSize: DWord;
                       Entry: PEntryProc); cdecl; external CCXBXDLLNAME name CCXBXKRNLINIT;
procedure DxbxKrnl_Init(hwndParent: THandle;
                       ...
                       pXbeHeader: P_XBE_HEADER;
                       dwXbeHeaderSize: DWord;
                       Entry: PEntryProc); cdecl; external CDXBXKRNLDLLNAME name CCXBXKRNLINIT;
(*
