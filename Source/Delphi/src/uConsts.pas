...
const
  ...
  XBE_LIBRARYVERSION_FLAG_ApprovedNo = $0000;
  XBE_LIBRARYVERSION_FLAG_ApprovedPossibly = $2000;
  XBE_LIBRARYVERSION_FLAG_ApprovedYes = $4000;
  XBE_LIBRARYVERSION_FLAG_ApprovedMask = $6000;
  XBE_LIBRARYVERSION_FLAG_DebugBuild = $8000;
